...
def list_stores():
    ...
    for s in stores:
        response.append(StoreStatusResponse(
            ...
            timezone=s.get("timezone", "Asia/Jakarta"),
            last_synced_at=s["last_synced_at"],
            desired_state=s.get("desired_state"),
            live_state=s.get("live_state"),
            bot_phase=s.get("bot_phase"),
            schedule_available=s.get("schedule_available"),
            schedule_fetch_status=s.get("schedule_fetch_status"),
            schedule_fetch_attempted_at=s.get("schedule_fetch_attempted_at"),
            schedule_fetch_succeeded_at=s.get("schedule_fetch_succeeded_at"),
            schedule_fetch_error=s.get("schedule_fetch_error"),
            within_operating_schedule=s.get("within_operating_schedule"),
            display_toggle_on=s.get("display_toggle_on"),
            display_toggle_disabled=s.get("display_toggle_disabled"),
            display_toggle_reason=s.get("display_toggle_reason"),
            display_status_bucket=s.get("display_status_bucket"),
            display_status_label=s.get("display_status_label"),
            display_status_tone=s.get("display_status_tone"),
            display_note=s.get("display_note"),
        ))
    return response
